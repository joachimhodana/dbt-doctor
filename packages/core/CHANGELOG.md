...
- Updated dependencies []:
  ...
  - @dbt-doctor/project-info@0.2.0-beta.6

## 0.2.0-beta.5

### Patch Changes

- [#252](https://github.com/joachimhodana/dbt-doctor/pull/252) [`2d90c1c`](https://github.com/joachimhodana/dbt-doctor/commit/2d90c1c5ae6d901913a575d40a784058478479ec) - Add public env-prefix detection (`get-public-env-prefix.ts`) and a
...
- [#260](https://github.com/joachimhodana/dbt-doctor/pull/260) [`b53d873`](https://github.com/joachimhodana/dbt-doctor/commit/b53d8730459d2dc469a8f9841def231048c8de7e) Thanks [@NisargIO](https://github.com/NisargIO)! - `run-oxlint.ts` + `runners/oxlint/config.ts` thread the new
...
- [#271](https://github.com/joachimhodana/dbt-doctor/pull/271) [`7a7ec84`](https://github.com/joachimhodana/dbt-doctor/commit/7a7ec84fad631d96f70279394be5f086b8424d17) - **Per-surface diagnostic filtering.** New public API:
...
- Updated dependencies [[`529015d`](https://github.com/joachimhodana/dbt-doctor/commit/529015d1d89441c4708f49413ecd540db7c04255)]:
  ...
  - @dbt-doctor/project-info@0.2.0-beta.3
...
- [#249](https://github.com/joachimhodana/dbt-doctor/pull/249) [`f0198e2`](https://github.com/joachimhodana/dbt-doctor/commit/f0198e2f2d9560a15bdb4a78f4a378ca2ac5fcdd) - **New public package.** Extracted from the `dbt-doctor` monolith
  in [#249](https://github.com/joachimhodana/dbt-doctor/pull/249).
  ...
  `dbt-doctor/src/utils/*` should switch to importing from
  `@dbt-doctor/core`.

### Patch Changes

- [#208](https://github.com/joachimhodana/dbt-doctor/pull/208) [`8556b31`](https://github.com/joachimhodana/dbt-doctor/commit/8556b31d8e4e165f791db0aa60a6b038b18ec777) - **User-feedback sweep.** Surface each rule's contribution to the
...
- [#254](https://github.com/joachimhodana/dbt-doctor/pull/254) [`bfaf9c9`](https://github.com/joachimhodana/dbt-doctor/commit/bfaf9c9530a9f8761df6e2d69abcf44c1699ff77) - `runners/oxlint/capabilities.ts` now consults the detected React
...
- [#257](https://github.com/joachimhodana/dbt-doctor/pull/257) [`ffbd20f`](https://github.com/joachimhodana/dbt-doctor/commit/ffbd20f3d0ebda2221d2ea93f87342165da90fdb) - Adds `runners/oxlint/resolve-use-call-binding.ts` (619 LOC binding
...
- [#262](https://github.com/joachimhodana/dbt-doctor/pull/262) [`bca5d30`](https://github.com/joachimhodana/dbt-doctor/commit/bca5d30fc549a16c4628001dcd2c5a83e85c04f8) - Eval-driven oxlint robustness pass. `run-oxlint.ts` now batches
...
- Updated dependencies []:
  - dbt-doctor-rules@0.2.0-beta.2
  - @dbt-doctor/project-info@0.2.0-beta.2
