...
- Updated dependencies []:
  ...
  - @dbt-doctor/project-info@0.3.0
  - @dbt-doctor/manifest@0.3.0
...
- [#252](https://github.com/joachimhodana/dbt-doctor/pull/252) [`2d90c1c`](https://github.com/joachimhodana/dbt-doctor/commit/2d90c1c5ae6d901913a575d40a784058478479ec) - `no-secrets-in-client-code` is scoped to client-reachable bindings.
...
- [#260](https://github.com/joachimhodana/dbt-doctor/pull/260) [`b53d873`](https://github.com/joachimhodana/dbt-doctor/commit/b53d8730459d2dc469a8f9841def231048c8de7e) Thanks [@NisargIO](https://github.com/NisargIO)! - `nextjs-no-side-effect-in-get-handler` stops flagging
  `response.headers.set(...)` and locally-constructed `Map` / `Set` /
...
- [#265](https://github.com/joachimhodana/dbt-doctor/pull/265) [`18b7033`](https://github.com/joachimhodana/dbt-doctor/commit/18b7033e9e9e6f45a13c1545c8c505922bd4ab8f) - `async-defer-await` no longer reports three legitimate shapes:
...
- [#269](https://github.com/joachimhodana/dbt-doctor/pull/269) [`838c7f4`](https://github.com/joachimhodana/dbt-doctor/commit/838c7f4174eaa9a7d0aea26d7e618bcc30818315) - `js-length-check-first` detects length guards anywhere earlier in an
...
- [#270](https://github.com/joachimhodana/dbt-doctor/pull/270) [`4cbf436`](https://github.com/joachimhodana/dbt-doctor/commit/4cbf4368485b91f85701b3eed177282006b69fbc) - `async-parallel` is suppressed in three legitimate contexts: test
...
- [#272](https://github.com/joachimhodana/dbt-doctor/pull/272) [`d821ca2`](https://github.com/joachimhodana/dbt-doctor/commit/d821ca2a82aa5e0eae0a8de0da32123fc1b89102) - `js-combine-iterations` skips lazy `Iterator` helper chains.
  ...
  eager `Array.prototype` chains. Resolves [#205](https://github.com/joachimhodana/dbt-doctor/issues/205).

- [#274](https://github.com/joachimhodana/dbt-doctor/pull/274) [`3b7cc7c`](https://github.com/joachimhodana/dbt-doctor/commit/3b7cc7c37336b21e4c0292dbb123b762b10a9a87) - `no-prevent-default` is framework-aware. Remix and Next.js
...
`dbt-doctor` runtime-dependency fix in beta.4.

## 0.2.0-beta.3

### Patch Changes

- [#253](https://github.com/joachimhodana/dbt-doctor/pull/253) [`9783acf`](https://github.com/joachimhodana/dbt-doctor/commit/9783acf525a30a4aa69b20bf37b893bb39b362b0) - `no-barrel-import` resolves each `index.{ts,tsx,js,jsx,mjs,cjs}`
...
- [#249](https://github.com/joachimhodana/dbt-doctor/pull/249) [`f0198e2`](https://github.com/joachimhodana/dbt-doctor/commit/f0198e2f2d9560a15bdb4a78f4a378ca2ac5fcdd) - **Plugin restructured into per-rule modules.** The kitchen-sink
  ...
  [#218](https://github.com/joachimhodana/dbt-doctor/pull/218) (initial
  per-file split),
  ...
  [#229](https://github.com/joachimhodana/dbt-doctor/pull/229) (port
  inline `node.type === "X"` checks to `isNodeOfType(node, "X")`),
  [#235](https://github.com/joachimhodana/dbt-doctor/pull/235) (drop
  loose `[key: string]: any` escape hatch from `EsTreeNode`),
  [#236](https://github.com/joachimhodana/dbt-doctor/pull/236) (split
  `rule-maps.ts` into external-plugin-rules + dbt-doctor-rules),
  and [#242](https://github.com/joachimhodana/dbt-doctor/pull/242)
...
- [#254](https://github.com/joachimhodana/dbt-doctor/pull/254) [`bfaf9c9`](https://github.com/joachimhodana/dbt-doctor/commit/bfaf9c9530a9f8761df6e2d69abcf44c1699ff77) - React-19-only rules
...
- [#255](https://github.com/joachimhodana/dbt-doctor/pull/255) [`6bc33c8`](https://github.com/joachimhodana/dbt-doctor/commit/6bc33c8aab2be7c7254ce9f2a059acbcdad17a58) - `rerender-state-only-in-handlers` /
...
- [#256](https://github.com/joachimhodana/dbt-doctor/pull/256) [`0cd9355`](https://github.com/joachimhodana/dbt-doctor/commit/0cd93551a4a4600282378125d9aa237ef655835a) - `no-effect-event-handler` narrows what counts as an event handler.
...
- [#257](https://github.com/joachimhodana/dbt-doctor/pull/257) [`ffbd20f`](https://github.com/joachimhodana/dbt-doctor/commit/ffbd20f3d0ebda2221d2ea93f87342165da90fdb) - Locally-defined functions whose name starts with `use…` (custom
