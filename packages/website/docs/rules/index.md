...
122 built-in rules. Configure severity and per-rule options in [`.dbt-doctor`](/docs/getting-started/configuration) at the repo root.
...
Terminate SQL scripts with a semicolon.
...
**warn** · SQL Style · tags: `style`, `phase5`
