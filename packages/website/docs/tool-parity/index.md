...
| [SQLFluff](/docs/tool-parity/sqlfluff)                 | 74 rule codes (stable bundle) | **100%** native; **100%** with `--use-sqlfluff` | Native SQL/Jinja parity map + deprecated subprocess fallback |
